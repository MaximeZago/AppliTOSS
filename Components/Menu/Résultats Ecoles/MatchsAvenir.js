...
import MatchFootball from '../Résultats Sports/Football/Masculin/MatchFootballAVenir'
...
export default class MatchsTermines extends React.Component{
    ...
    loadMatchs(){
        ...
        var docRef1 = db.collection("Sports").doc('FootballM').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        ...
        var docRef2 = db.collection("Sports").doc('FootballM').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        ...
        var docRef1 = db.collection("Sports").doc('FootballF').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('FootballF').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
                that.setState({matchsFootballF:that.state.matchsFootballF.concat(match)})
        ...
        var docRef1 = db.collection("Sports").doc('RugbyM').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('RugbyM').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
                that.setState({matchsRugbyM:that.state.matchsRugbyM.concat(match)})
        ...
        var docRef1 = db.collection("Sports").doc('RugbyF').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('RugbyF').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
                that.setState({matchsRugbyF:that.state.matchsRugbyF.concat(match)})
        ...
        var docRef1 = db.collection("Sports").doc('VolleyM').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('VolleyM').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
                that.setState({matchsVolleyM:that.state.matchsVolleyM.concat(match)})
        ...
        var docRef1 = db.collection("Sports").doc('VolleyF').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('VolleyF').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
                that.setState({matchsVolleyF:that.state.matchsVolleyF.concat(match)})
        ...
        var docRef1 = db.collection("Sports").doc('HandballM').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('HandballM').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
                that.setState({matchsHandballM:that.state.matchsHandballM.concat(match)})
        ...
        var docRef1 = db.collection("Sports").doc('HandballF').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('HandballF').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
                that.setState({matchsHandballF:that.state.matchsHandballF.concat(match)})
         ...
         var docRef1 = db.collection("Sports").doc('BasketballM').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
         docRef1.get().then(function(querySnapshot) {
             querySnapshot.forEach(function(doc) {
         ...
         var docRef2 = db.collection("Sports").doc('BasketballM').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
         docRef2.get().then(function(querySnapshot) {
             querySnapshot.forEach(function(doc) {
                 var match=doc.data()
                 that.setState({matchsBasketballM:that.state.matchsBasketballM.concat(match)})
         ...
         var docRef1 = db.collection("Sports").doc('BasketballF').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
         docRef1.get().then(function(querySnapshot) {
             querySnapshot.forEach(function(doc) {
         ...
         var docRef2 = db.collection("Sports").doc('BasketballF').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
         docRef2.get().then(function(querySnapshot) {
             querySnapshot.forEach(function(doc) {
                 var match=doc.data()
                 that.setState({matchsBasketballF:that.state.matchsBasketballF.concat(match)})
        ...
        var docRef1 = db.collection("Sports").doc('Tennis').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('Tennis').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
                that.setState({matchsTennis:that.state.matchsTennis.concat(match)})
        ...
        var docRef1 = db.collection("Sports").doc('TennisDeTable').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('TennisDeTable').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
        ...
        var docRef1 = db.collection("Sports").doc('Waterpolo').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('Waterpolo').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
        ...
        var docRef1 = db.collection("Sports").doc('Ultimate').collection("Matchs").where("idEquipe1","==",idEcole).where('matchTermine','==',false)
        docRef1.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
        ...
        var docRef2 = db.collection("Sports").doc('Ultimate').collection("Matchs").where("idEquipe2",'==',idEcole).where('matchTermine','==',false)
        docRef2.get().then(function(querySnapshot) {
            querySnapshot.forEach(function(doc) {
                var match=doc.data()
    ...
    render(){
        console.log(this.state.matchsFootballM)
        return(
