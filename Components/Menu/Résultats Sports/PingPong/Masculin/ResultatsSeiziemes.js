...
import MatchFoot from './MatchFootball'
import MatchFootAVenir from './MatchFootballAVenir'
    ...
    printMatch (n) {
        ...
        if (matchs.length >= n) {
            if (matchs[n-1].matchTermine) {
                return (
                    <MatchFoot equipe1 = {matchs[n-1].Equipe1}
                ...
                return (
                    <MatchFootAVenir equipe1 = {matchs[n-1].Equipe1}
                        equipe2 = {matchs[n-1].Equipe2}
                        scoreEquipe1 = {matchs[n-1].scoreEquipe1}
                        scoreEquipe2 = {matchs[n-1].scoreEquipe2}
                        idEcole1={matchs[n-1].idEquipe1}
