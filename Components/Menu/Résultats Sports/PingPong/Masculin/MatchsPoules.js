    ...
    render() {
        ...
        return (
            <View>
...

                {
                    ...
                    <View style={{borderColor:'#EBEBEB',borderWidth:1,marginHorizontal:10,marginVertical:10,height:210}}>
                        ...
                        <View style={{flexDirection:'row',height:30,borderColor:'#EBEBEB',borderBottomWidth:1}}>
                            ...
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                <Text style={styles.texteTitre}>PM</Text>
                            </View>
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                <Text style={styles.texteTitre}>PE</Text>
                            </View>
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                <Text style={styles.texteTitre}>DP</Text>
                            </View>
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                        ...
                        <View style={{flexDirection:'row',height:45,borderColor:'#EBEBEB',borderBottomWidth:1}}>
                            ...
                            <View style={{flex:1.5}}>
                                <Image style={{flex:1,height:null,width:null,margin:10,resizeMode:'contain'}} source={this.imageEcole(item.idEcole)}/>
                            </View>
                            ...
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                <Text style={styles.texteClassement}>{item.pointsPour}</Text>
                            </View>
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                <Text style={styles.texteClassement}>{item.pointsContre}</Text>
                            </View>
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                <Text style={styles.texteClassement}>{item.diffPoints}</Text>
                            </View>
                            <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                ...
                renderItem={({item}) => 
                <MatchFootball equipe1={item.Equipe1} equipe2={item.Equipe2} scoreEquipe1={item.scoreEquipe1} scoreEquipe2={item.scoreEquipe2} idEcole1={item.idEquipe1}
                idEcole2={item.idEquipe2} matchTermine={item.matchTermine} horaire={item.horaire} lieu={item.Lieu}/>
                }
                />
                <FlatList
                ...
                keyExtractor={(item)=> item.id.toString()}
                renderItem={({item}) => 
                <MatchFootballAVenir equipe1={item.Equipe1} equipe2={item.Equipe2} scoreEquipe1={item.scoreEquipe1} scoreEquipe2={item.scoreEquipe2} idEcole1={item.idEquipe1}
                idEcole2={item.idEquipe2} matchTermine={item.matchTermine} horaire={item.horaire} lieu={item.Lieu}/>
                }
                />
            </View>
