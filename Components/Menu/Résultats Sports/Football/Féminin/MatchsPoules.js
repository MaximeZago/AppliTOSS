    ...
    render() {
        ...
        return (
            <View>
                ...
                {
                    !this.state.loading?(
                    <View style={{borderColor:'#EBEBEB',borderWidth:1,marginHorizontal:10,marginVertical:10,height:255}}>
                ...
                keyExtractor={(item)=> item.id.toString()}
                renderItem={({item}) => 
                <MatchFootballAVenir equipe1={item.Equipe1} equipe2={item.Equipe2} scoreEquipe1={item.scoreEquipe1} scoreEquipe2={item.scoreEquipe2} idEcole1={item.idEquipe1} idEcole2={item.idEquipe2} matchTermine={item.matchTermine} horaire={item.horaire} lieu={item.Lieu}/>
                }
                />
            </View>
