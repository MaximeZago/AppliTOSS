...
import {View, Text,TouchableOpacity,RefreshControl,StyleSheet,TextInput,FlatList,Image,StatusBar,Picker,Animated,Dimensions,ScrollView,Platform} from 'react-native'
...
export default class ResultatsPoules extends React.Component{
    ...
    menuChoixPoule(){
        return(
            <Animated.View style={{position:'absolute',top:this.state.topPosition,height:300,width:width,backgroundColor:'white'}}>
                    ...
                    <View style={{flex:1,alignItems:'center'}}>
                        <Picker
                            ...
                            <Picker.Item label="Poule I" value="Poule I" />
                            <Picker.Item label="Poule J" value="Poule J" />
                            <Picker.Item label="Poule K" value="Poule K" />
                            <Picker.Item label="Poule L" value="Poule L" />
                            <Picker.Item label="Poule M" value="Poule M" />
                            <Picker.Item label="Poule N" value="Poule N" />
                            <Picker.Item label="Poule O" value="Poule O" />
                            <Picker.Item label="Poule P" value="Poule P" />
                        </Picker>
                    </View>
                </Animated.View>
        )
