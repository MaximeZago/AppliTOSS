...
import ResultatsFootF from './Féminin/ResultatsFootF'
      ...
      <Container>
            ...
            <View>
              ...
              <View style={{height:50,flexDirection:'row',backgroundColor:'#070027'}}>
                ...
                <View style={{flex:3,justifyContent:'center',alignItems:'center'}}>
                  <Text style={{color:'white',fontWeight:'bold',fontSize:18}}>Football by EDF</Text>
                </View>
                <View style={{flex:1}}>
                </View>
              </View>
        ...
        :
         ...
         <Header transparent style={{backgroundColor:'#070027',height:65}}>
          ...
          <Body style={{flex:5}}>
            <Title style={{color:'white'}}>Football by EDF</Title>
          </Body>
          <Right style={{flex:1}}/>  
        </Header> 
        }
