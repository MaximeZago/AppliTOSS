...
import MatchJudo from './MatchJudo'
import MatchJudoAVenir from './MatchJudoAVenir'

const firebase = require("firebase");
require("firebase/firestore");

export default class ResultatsDemies extends React.Component{
    ...
    _loadMatchs () {
        this.setState({donnees: []}, ()=>{
            ...
            var docRef = db.collection("Sports").doc(sport).collection("Matchs").where("Phase","==",'DEMIES')
    ...
    printMatch (n) {
        ...
        if (matchs.length >= n) {
            if (matchs[n-1].matchTermine) {
                return (
                    <MatchJudo equipe1 = {matchs[n-1].Equipe1}
                ...
                return (
                    <MatchJudoAVenir equipe1 = {matchs[n-1].Equipe1}
                        equipe2 = {matchs[n-1].Equipe2}
                        scoreEquipe1 = {matchs[n-1].scoreEquipe1}
                        scoreEquipe2 = {matchs[n-1].scoreEquipe2}
                        matchTermine = {matchs[n-1].matchTermine}
