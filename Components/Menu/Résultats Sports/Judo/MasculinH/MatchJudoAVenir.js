...
export default class MatchJudoAVenir extends React.Component {
                ...
                <Animated.View style = {{
                    ...
                    left: this.state.leftPosition}}>
                        ...
                        <View style = {{
                            ...
                            <Image source = {this.imageEcole(this.props.idEcole1)}
                                style = {{
                                height: 30,
                                width: 30,
                                marginRight: 5,
                            ...
                            <Text style = {{
                                ...
                                flex: 1,
                                flexWrap: 'wrap',
                                textAlign: 'center'}}>{this.props.equipe1}</Text>
                        </View>
                        ...
                        <View style = {{
                            ...
                            <View style = {{
                                ...
                                <Text style = {{
                                    ...
                                    fontSize: 10,
                                    textAlign:'center',
                                    color: '#C8102E'}}>{this.props.horaire}</Text>
                            </View>
                            ...
                            <View style = {{
                                ...
                                <Text style = {{
                                    ...
                                    fontSize: 10,
                                    textAlign:'center',
                                    color: '#C8102E'}}>{this.props.lieu}</Text>
                            </View>
                        </View>
                        ...
                        <View style = {{
                            ...
                            <Text style = {{
                                ...
                                flex: 1,
                                flexWrap: 'wrap',
                                textAlign: 'center'}}>{this.props.equipe2}</Text>
                            <Image source = {this.imageEcole(this.props.idEcole2)}
                                style = {{
                                height: 30,
                                width: 30,
                                marginRight: 10,
