        ...
        return (
            ...
            <View>
                    ...
                    <View style = {{
                        ...
                        <View style = {{
                            ...
                            <View style = {{
                                ...
                                justifyContent: 'center',
                                alignItems: 'center'}}>
                                <Text style = {styles.texteTitre}>DB</Text>
                            </View>
                        ...
                        <FlatList scrollEnabled = {false}
                            ...
                            <View style = {{
                                ...
                                <View style = {{
                                    ...
                                    justifyContent: 'center',
                                    alignItems: 'center'}}>
                                    <Text style = {styles.texteClassement}>{item.diffButs}</Text>
                                </View>
                ...
                <FlatList data = {this.state.matchsTermines}
                    ...
                    renderItem = {({item}) => 
                    <MatchJudo equipe1 = {item.Equipe1}
                ...
                <FlatList data = {this.state.matchsAVenir}
                    keyExtractor = {(item) => item.id.toString()}
                    renderItem = {({item}) => 
                    <MatchJudoAVenir equipe1 = {item.Equipe1}
                        equipe2 = {item.Equipe2}
                        scoreEquipe1 = {item.scoreEquipe1}
                        scoreEquipe2 = {item.scoreEquipe2}
                        matchTermine = {item.matchTermine}
