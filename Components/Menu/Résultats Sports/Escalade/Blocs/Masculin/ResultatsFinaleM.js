...
export default class ResultatsQualifsM extends React.Component{
    ...
    chargerParticipants(){
        ...
        var docRef=db.collection("Statistiques").doc('BlocM').collection('Participants').where("phase","==","finale")
                                ...
                                return(
                                    <View  style={{height :55, flexDirection: 'row',backgroundColor:this.choixStyle({index}),borderColor:'#EEEFF0',borderBottomWidth:1}}>
                                        <View style={{flex:6,flexDirection:'row'}}>
                                            ...
                                            <View style={{flexDirection:'row',alignItems:'center',flex:3.5,paddingRight:5,paddingLeft:5}}>
                                                <Text style={{fontWeight:'bold',marginLeft:5}} >{item.prenom} {item.nom}</Text>
                                            </View>
                                        </View>
                                    </View>
                                )
