...
import ResultatsBlocM from './Masculin/ResultatsBlocM'
import ResultatsBlocF from './Feminin/ResultatsBlocF'
...
export default class ResultatsDiff extends React.Component {
  ...
  displayVue () {
    if (this.state.masculin) {      
      return(<ResultatsBlocM/>) 
    }
    else {
      return(<ResultatsBlocF/>)    }
  }
      ...
      <Container>
            ...
            <View>
              ...
              <View style={{height:50,flexDirection:'row',backgroundColor:'#070027'}}>
                ...
                <View style={{flex:3,justifyContent:'center',alignItems:'center'}}>
                  <Text style={{color:'white',fontWeight:'bold',fontSize:18}}>Bloc</Text>
                </View>
                <View style={{flex:1}}>
                </View>
              </View>
        ...
        :
         ...
         <Header transparent style={{backgroundColor:'#070027',height:65}}>
          ...
          <Body style={{flex:5}}>
            <Title style={{color:'white'}}>Bloc</Title>
          </Body>
          <Right style={{flex:1}}/>  
        </Header> 
        }
