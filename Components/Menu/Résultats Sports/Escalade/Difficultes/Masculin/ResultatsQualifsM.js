...
export default class ResultatsQualifsM extends React.Component{
    ...
    chargerParticipants(){
        ...
        var docRef=db.collection("Statistiques").doc('DiffM').collection('Participants').where("phase","==","qualif")
