...
export default class MacthBasketball extends React.Component {
            ...
            <View>
                <Animated.View style={{height:50,flexDirection:'row',margin:5,borderWidth:1,borderRadius:10,borderColor:'#dedede',left:this.state.leftPosition}}>
                        <View style={{flex:5,flexDirection:'row',alignItems:'center',justifyContent:'flex-start'}}>
                            <Image source={this.imageEcole(this.props.idEcole1)} style={{height:30,width:30,marginRight:5,marginLeft:10,resizeMode:'contain'}}/>
                        ...
                        <View style={{flex:5,flexDirection:'row',justifyContent:'flex-end',alignItems:'center'}}>
                            ...
                            <Image source={this.imageEcole(this.props.idEcole2)} style={{height:30,width:30,marginLeft:5,marginRight:10,resizeMode:'contain'}}/>
                        </View>
                </Animated.View>
            </View>
        )
