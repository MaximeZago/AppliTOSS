                    ...
                    <View style = {{
                        ...
                        <View style = {{
                            ...
                            <View style = {{
                                ...
                                justifyContent: 'center',
                                alignItems: 'center'}}>
                                <Text style = {styles.texteTitre}>MG</Text>
                            </View>
                            ...
                            <View style = {{
                                ...
                                justifyContent: 'center',
                                alignItems: 'center'}}>
                                <Text style = {styles.texteTitre}>MP</Text>
                            </View>
                        ...
                        <FlatList scrollEnabled = {false}
                            ...
                            <View style = {{
                                ...
                                <View style = {{
                                    ...
                                    justifyContent: 'center',
                                    alignItems: 'center'}}>
                                    <Text style = {styles.texteClassement}>{item.MatchPour}</Text>
                                </View>
                                ...
                                <View style = {{
                                    ...
                                    justifyContent: 'center',
                                    alignItems: 'center'}}>
                                    <Text style = {styles.texteClassement}>{item.MatchContre}</Text>
                                </View>
