...
import {View, Text, RefreshControl, ScrollView, StyleSheet, ActivityIndicator, FlatList, Image} from 'react-native'
import {Font} from 'expo'

const firebase = require("firebase");
require("firebase/firestore");

export default class ResultatsFinal extends React.Component {
    ...
    loadClassement () {
        this.setState({stats: []}, () => {
            ...
            var docRef = db.collection("Statistiques").doc("Escrime").collection(sport).where("phase","==","final")
                        ...
                        <FlatList scrollEnabled = {false}
                            ...
                            <View style = {{
                                ...
                                <View style = {{
                                    ...
                                    justifyContent: 'center',
                                    alignItems: 'center'}}>
                                    <Text style = {styles.texteClassement}>{item.touchesContre}</Text>
                                </View>
