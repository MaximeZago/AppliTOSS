...
import {View, Text, RefreshControl, Image, ScrollView, StyleSheet, ActivityIndicator, FlatList} from 'react-native'
...
export default class ResultatsPoules extends React.Component {
    ...
    loadClassement () {
        this.setState({stats: []}, () => {
            ...
            var docRef = db.collection("Statistiques").doc("Escrime").collection(sport).where("phase","==","poules")
    ...
    sortClassement () {
        ...
        statsliste.sort(function (tireur1, tireur2) {
            return (tireur1.classement - tireur2.classement)
        })
                    ...
                    <View style = {{
                        ...
                        <View style = {{
                            ...
                            <View style = {{
                                ...
                                alignItems: 'center'}}>
                                <Text style = {styles.texteTitre}>MT</Text>
                            </View>
                            ...
                            <View style = {{
                                ...
                                justifyContent: 'center',
                                alignItems: 'center'}}>
                                <Text style = {styles.texteTitre}>TP</Text>
                            </View>
                            ...
                            <View style = {{
                                ...
                                justifyContent: 'center',
                                alignItems: 'center'}}>
                                <Text style = {styles.texteTitre}>TC</Text>
                            </View>
                            ...
                            <View style = {{
                                ...
                                <View style = {{flex: 1.5}}>
                                    <Image style = {{
                                        ...
                                        margin: 10,
                                        resizeMode: 'contain'}}
                                        source = {this.imageEcole(item.id)}/>
                                </View>
                                ...
                                <View style = {{
                                    ...
                                    justifyContent: 'center',
                                    alignItems: 'center'}}>
                                    <Text style = {styles.texteClassement}>{item.matchTires}</Text>
                                </View>
                                ...
                                <View style = {{
                                    ...
                                    justifyContent: 'center',
                                    alignItems: 'center'}}>
                                    <Text style = {styles.texteClassement}>{item.touchesPour}</Text>
                                </View>
                                ...
                                <View style = {{
                                    ...
                                    justifyContent: 'center',
                                    alignItems: 'center'}}>
                                    <Text style = {styles.texteClassement}>{item.touchesContres}</Text>
                                </View>
