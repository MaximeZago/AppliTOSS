...
export default class ResultatsCheer extends React.Component{
    ...
    chargerEcoles(){
        ...
        var docRef=db.collection("Statistiques").doc('Cheerleading').collection('Ecoles')
    ...
    displayLoading(){
        if (this.state.loading){
            ...
            if (this.state.listeEquipes.length===0){
                return(
                <View style={{flex:1,justifyContent:'center',alignItems:'center',marginHorizontal:20}}><Text style={{fontWeight:'bold',fontSize:20,textAlign:'center'}}>Rendez vous samedi à 18 h au gymnase Bouygues</Text></View>
                )
            }
            else{
                return(
    ...
    render() {
            ...
            <View>
              ...
              <View style={{height:50,flexDirection:'row',backgroundColor:'#070027'}}>
                ...
                <View style={{flex:3,justifyContent:'center',alignItems:'center'}}>
                  <Text style={{color:'white',fontWeight:'bold',fontSize:18}}>Classement Cheerleading</Text>
                </View>
                <View style={{flex:1}}>
                </View>
              </View>
        ...
        :
         ...
         <Header transparent style={{backgroundColor:'#070027',height:65}}>
          ...
          <Body style={{flex:5}}>
            <Title style={{color:'white'}}>Classement Cheerleading</Title>
          </Body>
          <Right style={{flex:1}}/>  
        </Header> 
        }
